                ...
                <main className="pa4 black-80">
                    <div className="measure">
                        ...
                        <div className="mt3">
                            ...
                            <input onChange={this.onNameChange} autoComplete="off" className="pa2 input-reset ba b--black bg-transparent hover-bg-black hover-white w-100" type="text" name="name"  id="name" />
                        </div>
                        <div className="mt3">
